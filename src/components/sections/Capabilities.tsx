      ...
      <div ref={ref} className="section-container relative z-10">
        ...
        <div className="relative grid gap-10 lg:grid-cols-[280px_1fr] lg:gap-16">
          ...
          <div className="relative">
            <div className="absolute left-3 top-0 h-full w-px bg-gradient-to-b from-primary/60 via-border to-accent/40 lg:left-0 lg:top-8 lg:h-px lg:w-full" />
            <div className="grid gap-8 lg:grid-cols-4">
              {content.map((item, index) => (
                ...
                >
                  <span className="absolute left-0 top-1 flex h-6 w-6 items-center justify-center rounded-full border border-primary/50 bg-background text-[10px] font-bold text-primary lg:top-5">
                  ...
                  <p className="font-mono text-xs leading-6 text-muted-foreground/90">
                    {item.items.join(" / ")}
                  </p>
                </motion.article>
              ))}
